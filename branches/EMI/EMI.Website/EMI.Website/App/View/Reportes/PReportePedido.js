Ext.define("App.View.Reportes.PReportePedido", {
    ...
    CargarEventos : function(){
        ...
        me.btn1.on('click', function () {
			if (me.form.isValid()) {
					me.panel.load(
						Constantes.HOST + 'Reportes/ReportePedidos.aspx?FECHA_INI=' + me.date_fechaIni.getSubmitValue() + '&FECHA_FIN=' + me.date_fechaFin.getSubmitValue() + '&ID_UNIDAD=' + Constantes.USUARIO.ID_UNIDAD
					);
                }
			else {
    ...
    CargarComponentes: function () {
        ...
        me.form.add([me.date_fechaIni,me.date_fechaFin, me.btn1 ]);
        //me.form = form;
