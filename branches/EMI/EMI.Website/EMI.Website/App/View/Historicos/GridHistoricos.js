Ext.define("App.View.Historicos.GridHistoricos", {
    extend: "Ext.grid.Panel",
    title: "",
    width: 650,
    height: 500,
    title: "Historicos de Edicion",
    ...
    CrearColumnas: function () {
        ...
        me.columns = [
           { xtype: "rownumberer", width: 30, sortable: false },
            { header: "Detalle", width: 430, sortable: false, dataIndex: "DETALLE", renderer: me.renderDetalle },
            { header: "Fecha Edicion", width: 150, sortable: false, dataIndex: "FECHA", renderer: me.renderPost },
    ...
    renderPost: function (value, p, r) {
        return Ext.String.format('{0}<p/> Por <strong>{1}</strong>', Ext.Date.dateFormat(value, 'd/m/Y g:i a'), r.get('USUARIO'));
    },
