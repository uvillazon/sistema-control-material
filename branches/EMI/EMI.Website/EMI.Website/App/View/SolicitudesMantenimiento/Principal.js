Ext.define("App.View.SolicitudesMantenimiento.Principal", {
    ...
    VerificarCampoMensaje: function (msg, ID, objecto, form, result) {
        ...
        if (Ext.util.Format.substr(msg, 0, 2) == '01') {
            ...
            btn_repoteRepetidos.on('click', function () {
                me.generarReporte(objecto == "POSTE" ? form.cmp_codigoPoste.txt_detalleComponente.getValue() : form.cmp_codigoPuesto.txt_detalleComponente.getValue(), objecto, result);
                return false;
            });
    ...
    generarReporte: function (codigo, objeto, result) {
        var me = this;
        ...
        if (objeto != null && codigo != '') {
            if (file != null) {
                ...
                window.open(Constantes.HOST + 'Reportes/ReporteObjRepetidos?OBJETO=' + objeto + "&CODIGO=" + codigo);
            }
        }
        else {
                ...
                if (result == null) {
                    Ext.Ajax.request({
                        ...
                        success: function (response, options) {
                            ...
                            if (data.data != null) {
                                result = data;
                                me.generarReporte(null,null,result)
                            } else {
