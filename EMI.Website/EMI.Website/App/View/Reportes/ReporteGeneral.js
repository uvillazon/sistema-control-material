Ext.define("App.View.Reportes.ReporteGeneral", {
    ...
    EventosForm: function () {
        ...
        me.btn_guardar.on('click', function () {
            //me.close();
            window.open(Constantes.HOST + 'Reportes/ReporteExistencias.aspx?ANIO=' + me.cbx_anio.getValue() + '&MES=' + me.cbx_mes.getValue() + '&ID_UNIDAD=' + Constantes.USUARIO.ID_UNIDAD);
            me.close();
        });
        me.btn3.on('click', function () {
            //me.close();
            window.open(Constantes.HOST + 'Reportes/ReporteExistenciasGraf.aspx?ANIO=' + me.cbx_anio.getValue() + '&MES=' + me.cbx_mes.getValue() + '&ID_UNIDAD=' + Constantes.USUARIO.ID_UNIDAD);
            me.close();
        });
    }
});
