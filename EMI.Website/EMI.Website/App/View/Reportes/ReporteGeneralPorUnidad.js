Ext.define("App.View.Reportes.ReporteGeneralPorUnidad", {
    ...
    EventosForm: function () {
        ...
        me.btn_guardar.on('click', function () {
            //me.close();
            if (me.form.isValid()) {
                window.open(Constantes.HOST + 'Reportes/ReporteExistencias.aspx?ANIO=' + me.cbx_anio.getValue() + '&MES=' + me.cbx_mes.getValue() + '&ID_UNIDAD=' + me.cbx_unidad.getValue());
                me.close();
            }
            else {
        ...
        me.btn3.on('click', function () {
            //me.close();
            if (me.form.isValid()) {
                window.open(Constantes.HOST + 'Reportes/ReporteExistenciasGraf.aspx?ANIO=' + me.cbx_anio.getValue() + '&MES=' + me.cbx_mes.getValue() + '&ID_UNIDAD=' + me.cbx_unidad.getValue());
                me.close();
            }
            else {
                Ext.Msg.alert("Error", "Falta Completar Formulario");
