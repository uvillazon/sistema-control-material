<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteExistenciasGraf.aspx.cs" Inherits="EMI.Website.Reportes.ReporteExistenciasGraf1" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="521px" Width="1089px">
            <LocalReport ReportEmbeddedResource="EMI.Website.Reportes.ReporteExistenciasGraf.rdlc" ReportPath="Reportes\ReporteExistenciasGraf.rdlc" OnSubreportProcessing="Unnamed_SubreportProcessing">
                <DataSources>
